...
/**
 * Invented names throughout, on purpose — see the fixture-naming guardrail
 * in the task summary. Real player names attached to generated news/
 * transaction/injury copy reads as reporting about real people; that's the
 * one thing here that could actually cause a problem. Real league structure
 * (teams, divisions, thresholds) stays real; people are fictional.
 */
const PLAYERS_BASE: Player[] = [
  { id: 'tatum', league: 'nba', sport: 'basketball', firstName: 'Malik', lastName: 'Voss', fullName: 'Malik Voss', teamId: 'BOS', position: 'SF', jerseyNumber: 0, heightInches: 80, weightLbs: 210, birthDate: '1998-03-03', draft: { year: 2017, round: 1, pick: 3, college: 'Duke', country: 'USA' }, status: 'active', source: FIXTURE },
  { id: 'brown', league: 'nba', sport: 'basketball', firstName: 'Devon', lastName: 'Ashworth', fullName: 'Devon Ashworth', teamId: 'BOS', position: 'SG', jerseyNumber: 7, heightInches: 78, weightLbs: 223, birthDate: '1996-10-24', draft: { year: 2016, round: 1, pick: 3, college: 'California', country: 'USA' }, status: 'active', source: FIXTURE },
  { id: 'white', league: 'nba', sport: 'basketball', firstName: 'Trey', lastName: 'Calloway', fullName: 'Trey Calloway', teamId: 'BOS', position: 'PG', jerseyNumber: 9, heightInches: 76, weightLbs: 190, birthDate: '1994-07-02', draft: { year: 2017, round: 1, pick: 29, college: 'Colorado', country: 'USA' }, status: 'active', source: FIXTURE },
  { id: 'porzingis', league: 'nba', sport: 'basketball', firstName: 'Anders', lastName: 'Kovac', fullName: 'Anders Kovac', teamId: 'BOS', position: 'C', jerseyNumber: 8, heightInches: 87, weightLbs: 240, birthDate: '1995-08-02', draft: { year: 2015, round: 1, pick: 4, country: 'Latvia' }, status: 'injured', source: FIXTURE },

  { id: 'sga', league: 'nba', sport: 'basketball', firstName: 'Jamir', lastName: 'Otieno', fullName: 'Jamir Otieno', teamId: 'OKC', position: 'PG', jerseyNumber: 2, heightInches: 78, weightLbs: 195, birthDate: '1998-07-12', draft: { year: 2018, round: 1, pick: 11, college: 'Kentucky', country: 'Canada' }, status: 'active', source: FIXTURE },
  { id: 'holmgren', league: 'nba', sport: 'basketball', firstName: 'Reid', lastName: 'Sorensen', fullName: 'Reid Sorensen', teamId: 'OKC', position: 'C', jerseyNumber: 7, heightInches: 84, weightLbs: 208, birthDate: '2002-05-01', draft: { year: 2022, round: 1, pick: 2, college: 'Gonzaga', country: 'USA' }, status: 'active', source: FIXTURE },
  { id: 'jwilliams', league: 'nba', sport: 'basketball', firstName: 'Kellan', lastName: 'Ruiz', fullName: 'Kellan Ruiz', teamId: 'OKC', position: 'SF', jerseyNumber: 8, heightInches: 78, weightLbs: 211, birthDate: '2001-05-14', draft: { year: 2022, round: 1, pick: 12, college: 'Santa Clara', country: 'USA' }, status: 'active', source: FIXTURE },
  { id: 'dort', league: 'nba', sport: 'basketball', firstName: 'Marcus', lastName: 'Deng', fullName: 'Marcus Deng', teamId: 'OKC', position: 'SG', jerseyNumber: 5, heightInches: 76, weightLbs: 220, birthDate: '1999-04-19', draft: { year: null, round: null, pick: null, college: 'Arizona State', country: 'Canada' }, status: 'active', source: FIXTURE },

  { id: 'cunningham', league: 'nba', sport: 'basketball', firstName: 'Isaiah', lastName: 'Marsh', fullName: 'Isaiah Marsh', teamId: 'DET', position: 'PG', jerseyNumber: 2, heightInches: 78, weightLbs: 220, birthDate: '2001-09-25', draft: { year: 2021, round: 1, pick: 1, college: 'Oklahoma State', country: 'USA' }, status: 'active', source: FIXTURE },
  { id: 'ivey', league: 'nba', sport: 'basketball', firstName: 'Bryce', lastName: 'Holloway', fullName: 'Bryce Holloway', teamId: 'DET', position: 'SG', jerseyNumber: 23, heightInches: 76, weightLbs: 195, birthDate: '2002-02-13', draft: { year: 2022, round: 1, pick: 5, college: 'Purdue', country: 'USA' }, status: 'active', source: FIXTURE },
  { id: 'duren', league: 'nba', sport: 'basketball', firstName: 'Tobias', lastName: 'Ferran', fullName: 'Tobias Ferran', teamId: 'DET', position: 'C', jerseyNumber: 0, heightInches: 82, weightLbs: 250, birthDate: '2003-11-18', draft: { year: 2022, round: 1, pick: 13, college: 'Memphis', country: 'USA' }, status: 'active', source: FIXTURE },
  { id: 'athompson', league: 'nba', sport: 'basketball', firstName: 'Nico', lastName: 'Aldana', fullName: 'Nico Aldana', teamId: 'DET', position: 'SF', jerseyNumber: 9, heightInches: 79, weightLbs: 200, birthDate: '2003-01-30', draft: { year: 2023, round: 1, pick: 5, country: 'USA' }, status: 'injured', source: FIXTURE },
];
...
export const TRANSACTIONS: Transaction[] = [
  ...
  { id: 't2', league: 'nba', kind: 'extension', date: '2025-07-06', teamIds: ['DET'], playerIds: ['cunningham'], description: 'Isaiah Marsh signs a 5-year maximum extension with Detroit.', mechanism: 'Rookie-scale designated extension — cap hold converts to full salary at signing.', source: FIXTURE },
  { id: 't3', league: 'nba', kind: 'draft', date: '2022-06-23', teamIds: ['OKC'], playerIds: ['holmgren'], description: 'Thunder select Reid Sorensen 2nd overall in the 2022 draft.', mechanism: 'Rookie-scale slot #2 — automatic cap hold, no cap impact until signed.', source: FIXTURE },
  { id: 't4', league: 'nba', kind: 'trade', date: '2025-07-14', teamIds: ['LAL', 'CHA'], playerIds: [], description: 'Lakers and Hornets complete a three-team trade exception swap.', mechanism: 'Uses a $6.1M trade exception generated last February — no matching salary required.', source: FIXTURE },
  { id: 't5', league: 'nba', kind: 'signing', date: '2025-07-08', teamIds: ['MIA'], playerIds: [], description: 'Heat sign a free-agent wing to a two-year deal.', mechanism: 'Non-taxpayer mid-level exception, first year partially guaranteed.', source: FIXTURE },
  { id: 't6', league: 'nba', kind: 'waiver', date: '2025-11-10', teamIds: ['UTA'], playerIds: [], description: 'Jazz waive a non-guaranteed training-camp signing.', source: FIXTURE },
  { id: 't7', league: 'nba', kind: 'two-way-conversion', date: '2025-11-05', teamIds: ['SAS'], playerIds: [], description: 'Spurs convert a two-way contract to a standard NBA deal.', mechanism: 'Opens the two-way slot for a G League call-up; counts against the 15-man roster limit.', source: FIXTURE },
  { id: 't8', league: 'nba', kind: 'trade', date: '2025-06-28', teamIds: ['PHX', 'NOP'], playerIds: [], description: 'Suns send a protected first-round pick to New Orleans for salary-matching depth.', mechanism: 'Base-year compensation applies — outgoing salary counts at half value for matching.', source: FIXTURE },
  { id: 't9', league: 'nba', kind: 'extension', date: '2025-08-01', teamIds: ['DEN'], playerIds: [], description: 'Nuggets extend a starting-caliber wing on a below-market deal.', mechanism: 'Extend-and-trade eligible in one year under the veteran extension rules.', source: FIXTURE },
  { id: 't10', league: 'nba', kind: 'signing', date: '2025-10-02', teamIds: ['ATL'], playerIds: [], description: 'Hawks sign a veteran big to a minimum contract.', source: FIXTURE },
];
